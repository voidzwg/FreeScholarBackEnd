# Generated by Django 4.0.3 on 2022-12-01 03:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count', models.IntegerField(blank=True, null=True)),
                ('scholar', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='user.scholar')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='owner', to='user.user')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='sender', to='user.user')),
            ],
            options={
                'db_table': 'Message',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('field_id', models.IntegerField(db_column='_id', primary_key=True, serialize=False)),
                ('create_time', models.DateTimeField(blank=True, null=True)),
                ('comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='user.comment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='user.scholar')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='report', to='user.user')),
                ('reported', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='reported', to='user.user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply', models.TextField(blank=True, null=True)),
                ('audit_time', models.DateTimeField(blank=True, null=True)),
                ('scholar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='user.scholar')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='user.user')),
            ],
            options={
