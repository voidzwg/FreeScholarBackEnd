...
class Field(models.Model):
    ...
    def SavingRatingWord(self):
        Rating.rating_connection.zadd("HotWord", {self.field_id: self.count})
...
class Paper(models.Model):
    ...
    def calculate_points(self):
        return self.read_count+self.like_count * 2 + self.collect_count * 3

    def save_paper_data(self):
        Rating.rating_connection.zadd("HotPaper", {self.field_id: self.calculate_points()})
